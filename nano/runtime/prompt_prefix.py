...
from nano.utils.text import now
...
def build_prompt_prefix(
    ...
    static_sections = [identity, doing_tasks, actions, using_tools, tone_and_style, output_efficiency]
    if agent_instructions.strip():
        static_sections.append("# 8. Agent Instructions\n" + agent_instructions.strip())
