class FakeModelClient:
    ...
    Main Nano uses real provider clients behind the same `complete()` shape.
    mini-nano defaults to this fake client so the control loop is visible
    ...
    def complete(self, prompt, max_new_tokens=512, **_kwargs):
        ...
        if "Tool result:" in prompt:
            return "<final>mini-nano read the workspace through a tool and returned a final answer.</final>"
