...
def build_arg_parser():
    parser = argparse.ArgumentParser(description="Teaching-sized Nano agent harness.")
    parser.add_argument("prompt", nargs="*", help="One-shot prompt. If omitted, mini-nano starts a small REPL.")
...
def build_agent(args):
    ...
    run_store = RunStore(workspace.root / ".mini-nano" / "runs")
    return Nano(
...
def main(argv=None):
    ...
    while True:
        try:
            user_input = input("mini-nano> ").strip()
